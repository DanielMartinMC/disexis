...
import es.danielmc.rest.auth.exceptions.AuthDifferentPasswords;
import es.danielmc.rest.auth.exceptions.AuthExistingUsernameOrEmail;
import es.danielmc.rest.auth.exceptions.AuthSignInNotValid;
import es.danielmc.rest.auth.repositories.AuthUsersRepository;
import es.danielmc.rest.auth.services.jwt.JwtService;
import es.danielmc.rest.users.models.Role;
