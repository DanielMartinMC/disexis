...
import es.danielmc.rest.users.mappers.UsersMapper;
import es.danielmc.rest.users.models.User;
import es.danielmc.rest.users.repositories.UsersRepository;
...
public class UsersServiceImpl implements UsersService {
  ...
  public UserInfoResponse findById(Long id) {
    ...
    var dispositivos = dispositivosRepository.findByUsuarioId(id).stream().map(p -> p.getMarca()).toList();
    return usersMapper.toUserInfoResponse(user, dispositivos);
  }
  ...
  public void deleteById(Long id) {
    ...
    if (dispositivosRepository.existsByUsuarioId(id)) {
