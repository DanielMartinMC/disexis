package es.danielmc.config.auth;

import es.danielmc.rest.auth.services.jwt.JwtService;
import es.danielmc.rest.auth.services.users.AuthUsersService;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        if (StringUtils.hasText(userName)
            ...
            // Eliminada la llamada redundante a authUsersService.loadUserByUsername(userName);
